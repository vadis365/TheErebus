...
public class ErebusSurfaceRules {

    public static final DeferredRegister<MapCodec<? extends SurfaceRules.ConditionSource>> SOURCES = DeferredRegister.create(Registries.MATERIAL_CONDITION, Erebus.MODID);
    ...
    public static SurfaceRules.ConditionSource simplexGradient(String randomName, VerticalAnchor trueAtAndBelow, VerticalAnchor falseAtAndAbove, double noiseScale) {
        return new SimplexGradientConditionSource(ResourceLocation.parse(randomName), trueAtAndBelow, falseAtAndAbove, noiseScale);
    }
