...
public class SubmergedSwampBiome extends ErebusBiome {
    ...
    public ResourceKey<Biome> getResourceKey() {
        return ModBiomes.SUBMERGED_SWAMP_KEY;
    }
    ...
    public Biome getBiome(HolderGetter<PlacedFeature> featureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
        return new Biome.BiomeBuilder()
                ...
                .mobSpawnSettings(new MobSpawnSettings.Builder()
                        ...
                        .addSpawn(MobCategory.CREATURE, 100, new MobSpawnSettings.SpawnerData(ModEntities.POND_SKATER.get(), 3, 5))
                        .addSpawn(MobCategory.MONSTER, 20, new MobSpawnSettings.SpawnerData(ModEntities.BOG_MAW.get(), 2, 3))
                        .addSpawn(MobCategory.MONSTER, 20, new MobSpawnSettings.SpawnerData(ModEntities.MOSQUITO.get(), 3, 4))
                        .build()
                )
