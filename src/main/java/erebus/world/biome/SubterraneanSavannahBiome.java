    ...
    public Biome getBiome(HolderGetter<PlacedFeature> featureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
        return new Biome.BiomeBuilder()
                ...
                .mobSpawnSettings(new MobSpawnSettings.Builder()
                        ...
                        .addSpawn(MobCategory.MONSTER, 15, new MobSpawnSettings.SpawnerData(ModEntities.FLY.get(), 8, 8))
                        ...
                        .addSpawn(MobCategory.CREATURE, 10, new MobSpawnSettings.SpawnerData(ModEntities.GRASSHOPPER.get(), 4, 8))
