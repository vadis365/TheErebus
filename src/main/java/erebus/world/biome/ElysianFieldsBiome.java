...
public class ElysianFieldsBiome extends ErebusBiome {
    ...
    public ResourceKey<Biome> getResourceKey() {
        return ModBiomes.ELYSIAN_FIELDS_KEY;
    }
    ...
    public Biome getBiome(HolderGetter<PlacedFeature> featureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
        return new Biome.BiomeBuilder()
                ...
                .mobSpawnSettings(new MobSpawnSettings.Builder()
                        ...
                        //.addSpawn(MobCategory.CREATURE, 10, new MobSpawnSettings.SpawnerData(ModEntities.VELVET_WORM.get(), 1, 2)) Crop Weevil
                        //.addSpawn(MobCategory.CREATURE, 10, new MobSpawnSettings.SpawnerData(ModEntities.VELVET_WORM.get(), 1, 2)) Chameleon Tick
                        //.addSpawn(MobCategory.CREATURE, 10, new MobSpawnSettings.SpawnerData(ModEntities.VELVET_WORM.get(), 1, 2)) Cicada
