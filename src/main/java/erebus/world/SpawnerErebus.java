...
public final class SpawnerErebus {
	...
	public static void onChunkPopulate(World world, Random rand, BiomeBaseErebus biome, int x, int z) {
		if (!world.isRemote && world.getGameRules().getGameRuleBooleanValue("doMobSpawning") && world.getTotalWorldTime()%10 == 0)
	...
	public void onServerTick(ServerTickEvent e) {
		...
		if(erebusWorld.playerEntities.isEmpty())
			return;
		if (erebusWorld != null && erebusWorld.getGameRules().getGameRuleBooleanValue("doMobSpawning") && erebusWorld.getTotalWorldTime()%10 == 0)
