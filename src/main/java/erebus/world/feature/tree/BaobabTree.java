...
import erebus.world.feature.tree.trunkplacer.BaobabTrunkPlacer;
...
public class BaobabTree extends ErebusTree {
    ...
    public List<PlacementModifier> getPlacementModifiers() {
        return VegetationPlacements.treePlacement(PlacementUtils.countExtra(3, 0.1F, 2), ModBlocks.SAPLING_BAOBAB.get());
    }
}
