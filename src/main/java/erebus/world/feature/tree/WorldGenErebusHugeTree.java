...
public class WorldGenErebusHugeTree extends WorldGenerator { // TODO
	...
	public WorldGenErebusHugeTree(boolean par1, int par3, int par4, boolean par5, Block woodBlock, Block leafBlock){
		super(par1);
		woodMetadata = par3;
		leavesMetadata = par4;
		thorns = par5;
				...
				for (var10 = x - var9; var10 <= x + var9 && var7; ++var10)
					for (var11 = z - var9; var11 <= z + var9 && var7; ++var11)
						if (var8 >= 0 && var8 < 256) {
							...
							if (!block.isLeaves(world,var10,var8,var11) && block != Blocks.grass && block != Blocks.dirt && !block.isWood(world,var10,var8,var11) && block != Blocks.sapling)
								var7 = false;
						} else
							var7 = false;
			}
				...
				if ((block == Blocks.grass || block == Blocks.dirt) && y < 256 - var6 - 1) {
					...
					for (int var14 = y + var6 - 2 - rand.nextInt(4); var14 > y + var6 / 2; var14 -= 2 + rand.nextInt(4)) {
						...
						for (int var13 = 0; var13 < 5; ++var13) {
							...
							world.setBlock(var11,var14 - 3 + var13 / 2,var12,woodBlock,woodMetadata,2);
						}
					}
					...
					for (var10 = 0; var10 < var6; ++var10) {
						...
						if (block.getMaterial() == Material.air || block.isLeaves(world,x,y + var10,z)) {
							world.setBlock(x,y + var10,z,woodBlock,woodMetadata,2);
						...
						if (var10 < var6 - 1) {
							...
							if (block.getMaterial() == Material.air || block.isLeaves(world,x + 1,y + var10,z)) {
								world.setBlock(x + 1,y + var10,z,woodBlock,woodMetadata,2);
							...
							if (block.getMaterial() == Material.air || block.isLeaves(world,x + 1,y + var10,z + 1)) {
								world.setBlock(x + 1,y + var10,z + 1,woodBlock,woodMetadata,2);
							...
							if (block.getMaterial() == Material.air || block.isLeaves(world,x,y + var10,z + 1)) {
								world.setBlock(x,y + var10,z + 1,woodBlock,woodMetadata,2);
