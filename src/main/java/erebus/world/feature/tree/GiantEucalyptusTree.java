...
import erebus.world.feature.tree.trunkplacer.GiantEucalyptusTrunkPlacer;
...
public class GiantEucalyptusTree extends ErebusTree {
    ...
    public List<PlacementModifier> getPlacementModifiers() {
        return VegetationPlacements.treePlacement(PlacementUtils.countExtra(3, 0.1F, 2), ModBlocks.SAPLING_EUCALYPTUS.get());
    }
}
