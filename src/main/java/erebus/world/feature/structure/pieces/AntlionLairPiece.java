...
public class AntlionLairPiece extends ScatteredFeaturePiece {
    protected AntlionLairPiece(int x, int y, int z, int width, int height, int depth, Direction orientation) {
        super(ModStructurePieces.ANTLION_LAIR.get(), x, y, z, width, height, depth, orientation);
    }
