...
public class LocustShrinePiece extends ScatteredFeaturePiece {
    protected LocustShrinePiece(int x, int y, int z, int width, int height, int depth, Direction orientation) {
        super(ModStructurePieces.LOCUST_SHRINE.get(), x, y, z, width, height, depth, orientation);
    }
