...
public class DungPilePiece extends ScatteredFeaturePiece {
    protected DungPilePiece(int x, int y, int z, int width, int height, int depth, Direction orientation) {
        super(ModStructurePieces.DUNG_PILE.get(), x, y, z, width, height, depth, orientation);
    }
