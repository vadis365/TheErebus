...
public class SwampHutPiece extends ScatteredFeaturePiece {
    protected SwampHutPiece(int x, int y, int z, int width, int height, int depth, Direction orientation) {
        super(ModStructurePieces.SWAMP_HUT.get(), x, y, z, width, height, depth, orientation);
    }
