...
public class WaspDungeonPiece extends ScatteredFeaturePiece {
    protected WaspDungeonPiece(int x, int y, int z, int width, int height, int depth, Direction orientation) {
        super(ModStructurePieces.WASP_DUNGEON.get(), x, y, z, width, height, depth, orientation);
    }
