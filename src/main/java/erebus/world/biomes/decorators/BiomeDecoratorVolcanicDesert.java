	...
	protected void modifyOreGen(OreSettings oreGen, OreType oreType, boolean extraOres) {
		switch (oreType) {
			...
			case GOLD:
				...
				break; // less common
			case DIAMOND:
				oreGen.setChance(0.6F).setIterations(1).setOreAmount(4).setY(5, 16);
				break; // clusters of 4, ~7 times smaller area thus lowered chance and iterations // TODO special ore
			case JADE:
