...
public abstract class BiomeBaseErebus extends BiomeGenBase implements IWeightProvider
{
	...
	private short[] fogColorRGB = new short[]
	{ 255, 255, 255 };
	...
	/**
	 * Every time a biome is generated, this method is called to specify sub
	 * biome to generate inside the biome.
	 *
	 * @param randomValue
