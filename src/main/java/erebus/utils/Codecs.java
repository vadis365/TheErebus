...
public class Codecs {
    ...
    public static final StreamCodec<ByteBuf, BoundingBox> BOX_STREAM_CODEC = new StreamCodec<>() {
        @Override
        public @NotNull BoundingBox decode(ByteBuf buf) {
    ...
    public static <T> StreamCodec<ByteBuf, List<T>> listOf(StreamCodec<ByteBuf, T> elementCodec) {
        return new StreamCodec<>() {
            @Override
            public @NotNull List<T> decode(@NotNull ByteBuf buf) {
            ...
            @Override
            public void encode(@NotNull ByteBuf buf, @NotNull List<T> list) {
    ...
    public static final StreamCodec<ByteBuf, Pair<BoundingBox, Boolean>> BOX_AND_FLAG_STREAM_CODEC = new StreamCodec<>() {
        @Override
        public @NotNull Pair<BoundingBox, Boolean> decode(@NotNull ByteBuf buf) {
        ...
        @Override
        public void encode(@NotNull ByteBuf buf, Pair<BoundingBox, Boolean> boxAndFlag) {
