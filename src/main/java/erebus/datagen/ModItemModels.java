...
public class ModItemModels extends ModItemModelProvider {
    ...
    private void registerBlockItemModels() {
        ...
        slab(SlabBlocks.AMBER, AmberBlocks.AMBER);
        slab(SlabBlocks.AMBER_BRICKS, AmberBlocks.AMBER_BRICKS);
        ...
        stairs(StairBlocks.AMBER, AmberBlocks.AMBER);
        stairs(StairBlocks.AMBER_BRICKS, AmberBlocks.AMBER_BRICKS);
