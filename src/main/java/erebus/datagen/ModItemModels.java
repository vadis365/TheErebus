...
public class ModItemModels extends ModItemModelProvider {
    ...
    private void registerBlockItemModels() {
        ...
        block(TARANTULA_EGG);
        block(HONEY_TREAT);
        block(CANDLE_HONEY_TREAT);
        block(WHITE_CANDLE_HONEY_TREAT);
        block(ORANGE_CANDLE_HONEY_TREAT);
        block(MAGENTA_CANDLE_HONEY_TREAT);
        block(LIGHT_BLUE_CANDLE_HONEY_TREAT);
        block(YELLOW_CANDLE_HONEY_TREAT);
        block(LIME_CANDLE_HONEY_TREAT);
        block(PINK_CANDLE_HONEY_TREAT);
        block(GRAY_CANDLE_HONEY_TREAT);
        block(LIGHT_GRAY_CANDLE_HONEY_TREAT);
        block(CYAN_CANDLE_HONEY_TREAT);
        block(PURPLE_CANDLE_HONEY_TREAT);
        block(BLUE_CANDLE_HONEY_TREAT);
        block(BROWN_CANDLE_HONEY_TREAT);
        block(GREEN_CANDLE_HONEY_TREAT);
        block(RED_CANDLE_HONEY_TREAT);
        block(BLACK_CANDLE_HONEY_TREAT);
        block(WASP_NEST);
