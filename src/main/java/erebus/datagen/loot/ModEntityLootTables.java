                ...
                LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(ModBlocks.STIGMA_BLACK)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        .add(LootItem.lootTableItem(ModBlocks.STIGMA_RED)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        .add(LootItem.lootTableItem(ModBlocks.STIGMA_BROWN)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        .add(LootItem.lootTableItem(ModBlocks.STIGMA_BLUE)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        .add(LootItem.lootTableItem(ModBlocks.STIGMA_PURPLE)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        .add(LootItem.lootTableItem(ModBlocks.STIGMA_CYAN)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        .add(LootItem.lootTableItem(ModBlocks.STIGMA_LIGHT_GRAY)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        .add(LootItem.lootTableItem(ModBlocks.STIGMA_GRAY)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        .add(LootItem.lootTableItem(ModBlocks.STIGMA_PINK)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        .add(LootItem.lootTableItem(ModBlocks.STIGMA_YELLOW)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        .add(LootItem.lootTableItem(ModBlocks.STIGMA_LIGHT_BLUE)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        .add(LootItem.lootTableItem(ModBlocks.STIGMA_MAGENTA)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        .add(LootItem.lootTableItem(ModBlocks.STIGMA_ORANGE)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        .add(LootItem.lootTableItem(ModBlocks.STIGMA_WHITE)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                        )
                        .withPool(
                        ...
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(Items.RED_MUSHROOM)
                                                ...
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        // Custom mushrooms
                                        .add(LootItem.lootTableItem(ModBlocks.DARK_CAPPED_MUSHROOM)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        .add(LootItem.lootTableItem(ModBlocks.DUTCH_CAP_MUSHROOM)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        .add(LootItem.lootTableItem(ModBlocks.GRANDMAS_SHOES_MUSHROOM)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        .add(LootItem.lootTableItem(ModBlocks.KAIZERS_FINGERS_MUSHROOM)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                                        .add(LootItem.lootTableItem(ModBlocks.SARCASTIC_CZECH_MUSHROOM)
                                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(registries, UniformGenerator.between(0, 1))))
                        )
        );
