...
public class ShapelessCraftingRecipeProvider extends ErebusRecipeProvider {
    ...
    private void addPlanksRecipes() {
        ...
        shapeless(BUILDING_BLOCKS, WoodBlocks.PLANKS_VARNISHED)
    ...
    private void addMiscShapelessRecipes() {
        ...
        shapeless(BUILDING_BLOCKS, OtherBlocks.SILK)
        ...
        shapeless(BUILDING_BLOCKS, OtherBlocks.REIN_EXO)
        ...
        nineBlockStorageRecipes(MISC, ModItems.JADE, BUILDING_BLOCKS, OtherBlocks.JADE_BLOCK);
        ...
        shapeless(MISC, OtherBlocks.VELOCITY_BLOCK_LIGHTNING_SPEED)
        ...
        shapeless(MISC, OtherBlocks.BAMBOO_PIPE_EXTRACT)
