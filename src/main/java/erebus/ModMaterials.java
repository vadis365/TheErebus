...
public class ModMaterials {
	...
	public static ArmorMaterial armorREINEXOSKELETON = EnumHelper.addArmorMaterial("REINEXOSKELETON", 11, new int[] { 3, 8, 6, 3 }, 10);
	public static ArmorMaterial armorREINEXOSPECIAL = EnumHelper.addArmorMaterial("REINEXOSPECIAL", 11, new int[] { 3, 8, 6, 3 }, 10);
	public static ArmorMaterial armorRHINO = EnumHelper.addArmorMaterial("RHINO", 11, new int[] { 3, 8, 6, 3 }, 10);
