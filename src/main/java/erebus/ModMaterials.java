...
public class ModMaterials {
	...
	public static ToolMaterial weaponWaspSword = EnumHelper.addToolMaterial("WASPSWORD", 0, 863, 1.0F, 6.0F, 18);
	public static ToolMaterial weaponScorpionPincer = EnumHelper.addToolMaterial("SCORPIONPINCER", 0, 863, 1.0F, 4.0F, 12);
	...
	public static ToolMaterial weaponWarHammer = EnumHelper.addToolMaterial("WARHAMMER", 0, 863, 1.0F, 10.0F, 18);
