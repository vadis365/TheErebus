...
public class TileEntityErebusAltarRepairRenderer extends TileEntitySpecialRenderer<TileEntityErebusAltarRepair> {
	private static final ResourceLocation[] TEXTURE = new ResourceLocation[] { new ResourceLocation("erebus:textures/special/tiles/altar_repair_1.png"), new ResourceLocation("erebus:textures/special/tiles/altar_repair_2.png"), new ResourceLocation("erebus:textures/special/tiles/altar_repair_3.png"), new ResourceLocation("erebus:textures/special/tiles/altar_repair_4.png"), new ResourceLocation("erebus:textures/special/tiles/altar_repair_5.png") };

	private final ModelAltarRepair model = new ModelAltarRepair();
	private final ModelErebusAltar modelBasic = new ModelErebusAltar();

	public void renderTile(TileEntityErebusAltarRepair tile, double x, double y, double z, float partialTick, int destroyStage, float alpha) {
	...
	@Override
	public void render(TileEntityErebusAltarRepair tile, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
		if(tile == null || !tile.hasWorld()) {
	...
	protected ResourceLocation getAltarTexture(TileEntityErebusAltarRepair tile) {
