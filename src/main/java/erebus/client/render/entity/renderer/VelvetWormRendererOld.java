...
@OnlyIn(Dist.CLIENT)
public class VelvetWormRendererOld extends MobRenderer<VelvetWorm, VelvetWormModel<VelvetWorm>> {
	...
	public VelvetWormRendererOld(EntityRendererProvider.Context context) {
