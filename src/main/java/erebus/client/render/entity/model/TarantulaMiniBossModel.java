...
public class TarantulaMiniBossModel extends EntityModel<TarantulaMiniBossRenderState> {
    ...
    public TarantulaMiniBossModel(ModelPart root) {
        super(root);
        this.root = root;
    ...
    @Override
    public void setupAnim(TarantulaMiniBossRenderState state) {
