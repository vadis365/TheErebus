...
import net.neoforged.api.distmarker.OnlyIn;
	...
	@OnlyIn(Dist.CLIENT)
	public class BlackAntModel<T extends BlackAnt> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Thx2Ab = partdefinition.addOrReplaceChild("Thx2Ab", CubeListBuilder.create().texOffs(39, 55).addBox(-1.5F, -1.5F, 0.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 17.0F, 1.0F));
		...
		PartDefinition AbF = partdefinition.addOrReplaceChild("AbF", CubeListBuilder.create().texOffs(0, 62).addBox(-3.5F, -3.5F, -1.0F, 7.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 17.0F, 3.0F));

		PartDefinition AbSide = partdefinition.addOrReplaceChild("AbSide", CubeListBuilder.create().texOffs(19, 63).addBox(-6.5F, -2.5F, 2.0F, 13.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 17.0F, 3.0F));

		PartDefinition AbTop = partdefinition.addOrReplaceChild("AbTop", CubeListBuilder.create().texOffs(12, 80).addBox(-4.0F, -5.5F, 2.0F, 8.0F, 11.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 17.0F, 3.0F));
		...
		PartDefinition Eyes = Head1.addOrReplaceChild("Eyes", CubeListBuilder.create().texOffs(0, 35).addBox(-4.0F, 1.5F, -3.0F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition LeftPack = partdefinition.addOrReplaceChild("LeftPack", CubeListBuilder.create().texOffs(47, 15).addBox(4.0F, 0.5F, -2.5F, 3.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 11.0F, 8.0F, 0.0F, 0.0F, -0.2443F));

		PartDefinition StrapPack = partdefinition.addOrReplaceChild("StrapPack", CubeListBuilder.create().texOffs(42, 52).addBox(-5.0F, -0.5F, -0.5F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 11.0F, 8.0F));

		PartDefinition RightPack = partdefinition.addOrReplaceChild("RightPack", CubeListBuilder.create().texOffs(47, 27).addBox(-7.0F, 0.5F, -2.5F, 3.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 11.0F, 8.0F, 0.0F, 0.0F, 0.2618F));

		PartDefinition RightShears = partdefinition.addOrReplaceChild("RightShears", CubeListBuilder.create().texOffs(48, 55).addBox(-3.5F, -3.0F, -10.5F, 3.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 17.0F, -10.0F, 0.8727F, 0.0F, 0.0F));

		PartDefinition LeftShears = partdefinition.addOrReplaceChild("LeftShears", CubeListBuilder.create().texOffs(48, 40).addBox(0.5F, -3.0F, -10.5F, 3.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 17.0F, -10.0F, 0.8727F, 0.0F, 0.0F));

		PartDefinition HatTop = partdefinition.addOrReplaceChild("HatTop", CubeListBuilder.create().texOffs(44, 77).addBox(-2.5F, -4.0F, -5.0F, 5.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 17.0F, -9.0F, -0.4363F, 0.0F, 0.0F));

		PartDefinition HatBrimF = partdefinition.addOrReplaceChild("HatBrimF", CubeListBuilder.create().texOffs(0, 40).addBox(-3.0F, -2.0F, -8.0F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 17.0F, -9.0F, -0.4363F, 0.0F, 0.0F));

		PartDefinition HatBrimL = partdefinition.addOrReplaceChild("HatBrimL", CubeListBuilder.create().texOffs(0, 27).addBox(4.0F, -2.0F, -6.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 17.0F, -9.0F, -0.4363F, 0.0F, 0.0F));

		PartDefinition HatBrimMain = partdefinition.addOrReplaceChild("HatBrimMain", CubeListBuilder.create().texOffs(0, 52).addBox(-4.0F, -2.0F, -7.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 17.0F, -9.0F, -0.4363F, 0.0F, 0.0F));

		PartDefinition HatBrimR = partdefinition.addOrReplaceChild("HatBrimR", CubeListBuilder.create().texOffs(0, 43).addBox(-5.0F, -2.0F, -6.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 17.0F, -9.0F, -0.4363F, 0.0F, 0.0F));

		PartDefinition MachineThorax = partdefinition.addOrReplaceChild("MachineThorax", CubeListBuilder.create().texOffs(44, 85).addBox(-2.5F, -1.5F, -14.0F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 11.0F, 8.0F));

		PartDefinition ConduitR = partdefinition.addOrReplaceChild("ConduitR", CubeListBuilder.create().texOffs(18, 77).addBox(-1.0F, -0.5F, -5.5F, 9.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 11.0F, 8.0F, 0.0F, 1.0472F, 0.0F));

		PartDefinition ConduitL = partdefinition.addOrReplaceChild("ConduitL", CubeListBuilder.create().texOffs(18, 77).addBox(-8.0F, -0.5F, -5.5F, 9.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 11.0F, 8.0F, 0.0F, -1.0647F, 0.0F));

		PartDefinition SprayL = partdefinition.addOrReplaceChild("SprayL", CubeListBuilder.create().texOffs(0, 19).addBox(11.0F, 3.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 11.0F, 8.0F));

		PartDefinition SpayR = partdefinition.addOrReplaceChild("SpayR", CubeListBuilder.create().texOffs(0, 19).addBox(-13.0F, 3.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 11.0F, 8.0F));

		PartDefinition SprayLConduit = partdefinition.addOrReplaceChild("SprayLConduit", CubeListBuilder.create().texOffs(0, 24).addBox(8.0F, 3.5F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 11.0F, 8.0F));

		PartDefinition SprayRConduit = partdefinition.addOrReplaceChild("SprayRConduit", CubeListBuilder.create().texOffs(0, 24).addBox(-11.0F, 3.5F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 11.0F, 8.0F));
	...
	public void renderPlanter(PoseStack stack, VertexConsumer consumer, int light, int overlay, int colour) {
		LeftPack.render(stack, consumer, light, overlay, colour);
		StrapPack.render(stack, consumer, light, overlay, colour);
		RightPack.render(stack, consumer, light, overlay, colour);
		stack.pushPose();
		stack.translate(0F, -0.0625F, 0.0625F);
		HatTop.render(stack, consumer, light, overlay, colour);
		HatBrimF.render(stack, consumer, light, overlay, colour);
		HatBrimL.render(stack, consumer, light, overlay, colour);
		HatBrimMain.render(stack, consumer, light, overlay, colour);
		HatBrimR.render(stack, consumer, light, overlay, colour);
		stack.popPose();
	}

	public void renderHarvester(PoseStack stack, VertexConsumer consumer, int light, int overlay, int colour) {
		RightShears.render(stack, consumer, light, overlay, colour);
		LeftShears.render(stack, consumer, light, overlay, colour);
	}

	public void renderCollector(PoseStack stack, VertexConsumer consumer, int light, int overlay, int colour) {
		LeftPack.render(stack, consumer, light, overlay, colour);
		StrapPack.render(stack, consumer, light, overlay, colour);
		RightPack.render(stack, consumer, light, overlay, colour);
	}

	public void renderFertilizer(PoseStack stack, VertexConsumer consumer, int light, int overlay, int colour) {
		LeftPack.render(stack, consumer, light, overlay, colour);
		StrapPack.render(stack, consumer, light, overlay, colour);
		RightPack.render(stack, consumer, light, overlay, colour);
		MachineThorax.render(stack, consumer, light, overlay, colour);
		ConduitR.render(stack, consumer, light, overlay, colour);
		ConduitL.render(stack, consumer, light, overlay, colour);
		SprayL.render(stack, consumer, light, overlay, colour);
		SpayR.render(stack, consumer, light, overlay, colour);
		SprayLConduit.render(stack, consumer, light, overlay, colour);
		SprayRConduit.render(stack, consumer, light, overlay, colour);
	}
