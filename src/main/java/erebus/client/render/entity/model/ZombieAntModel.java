...
public class ZombieAntModel extends EntityModel<ZombieAntRenderState> {
	...
	public ZombieAntModel(ModelPart root) {
        super(root);
        this.root = root;
        root.getChild("Thx");
	...
	@Override
	public void setupAnim(ZombieAntRenderState state) {
