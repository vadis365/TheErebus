...
public class FireAntSoldierModel extends EntityModel<FireAntSoldierRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition HeadA = root.addOrReplaceChild("HeadA", CubeListBuilder.create().texOffs(0, 0).addBox(-4F, -0.5F, -4F, 8, 6, 6), PartPose.offsetAndRotation(0F, 16F, -1F, -1.0F, 0F, 0F));
        HeadA.addOrReplaceChild("HeadB", CubeListBuilder.create().texOffs(35, 0).addBox(-5F, -1.5F, -3F, 10, 8, 4), PartPose.ZERO);
        HeadA.addOrReplaceChild("RMandibleA", CubeListBuilder.create().texOffs(0, 44).addBox(-4F, 6F, -2F, 1, 3, 1), PartPose.ZERO);
        HeadA.addOrReplaceChild("RMandibleB", CubeListBuilder.create().texOffs(0, 36).addBox(-3F, 5.5F, -2F, 2, 6, 1).mirror(), PartPose.ZERO);
        HeadA.addOrReplaceChild("LMandibleA", CubeListBuilder.create().texOffs(0, 44).addBox(3F, 6F, -2F, 1, 3, 1), PartPose.ZERO);
        HeadA.addOrReplaceChild("LMandibleB", CubeListBuilder.create().texOffs(0, 36).addBox(1F, 5.5F, -2F, 2, 6, 1), PartPose.ZERO);
        HeadA.addOrReplaceChild("Eyes", CubeListBuilder.create().texOffs(0, 31).addBox(-6F, 1.5F, -2.5F, 12, 2, 2), PartPose.ZERO);
        HeadA.addOrReplaceChild("AntLS", CubeListBuilder.create().texOffs(0, 27).addBox(4.5F, 4.5F, -3F, 3, 1, 1), PartPose.rotation(0F, 0F, 0.1745329F));
        HeadA.addOrReplaceChild("AntLE", CubeListBuilder.create().texOffs(0, 21).addBox(7.5F, 5.5F, -3F, 1, 4, 1), PartPose.rotation(0F, 0F, 0.1745329F));
        HeadA.addOrReplaceChild("AntRS", CubeListBuilder.create().texOffs(0, 27).addBox(-7.5F, 4.5F, -3F, 3, 1, 1), PartPose.rotation(0F, 0F, -0.1745329F));
        HeadA.addOrReplaceChild("AntRE", CubeListBuilder.create().texOffs(0, 21).addBox(-8.5F, 5.5F, -3F, 1, 4, 1), PartPose.rotation(0F, 0F, -0.1745329F));
        ...
        LBLA.addOrReplaceChild("LBLD", CubeListBuilder.create().texOffs(0, 76).addBox(0.5F, 8F, -0.5F, 1, 4, 1), PartPose.rotation(0.39F, 0F, -0.77F));
        ...
        LMLA.addOrReplaceChild("LMLC", CubeListBuilder.create().texOffs(0, 82).addBox(1.5F, 4.5F, -0.5F, 2, 4, 1), PartPose.rotation(0F, 0F, -0.3490658F));
        LMLA.addOrReplaceChild("LMLD", CubeListBuilder.create().texOffs(0, 76).addBox(0.5F, 8F, -0.5F, 1, 4, 1), PartPose.rotation(0F, 0F, -0.5235987F));
        ...
        LFLA.addOrReplaceChild("LFLD", CubeListBuilder.create().texOffs(0, 76).addBox(0.5F, 8F, -0.5F, 1, 4, 1), PartPose.rotation(-0.39F, 0F, -0.77F));
        ...
        RFLA.addOrReplaceChild("RFLD", CubeListBuilder.create().texOffs(0, 76).addBox(-1.5F, 8F, -0.5F, 1, 4, 1), PartPose.rotation(-0.39F, 0F, 0.77F));
        ...
        RMLA.addOrReplaceChild("RMLC", CubeListBuilder.create().texOffs(0, 82).addBox(-3.5F, 4.5F, -0.5F, 2, 4, 1), PartPose.rotation(0F, 0F, 0.3490658F));
        RMLA.addOrReplaceChild("RMLD", CubeListBuilder.create().texOffs(0, 76).addBox(-1.5F, 8F, -0.5F, 1, 4, 1), PartPose.rotation(0F, 0F, 0.5235987F));
