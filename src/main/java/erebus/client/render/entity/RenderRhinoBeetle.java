...
public class RenderRhinoBeetle extends RenderLiving {
	...
	public void renderRhinoBeetle(EntityRhinoBeetle entityRhinoBeetle, double x, double y, double z, float rotationYaw, float partialTickTime) {
		super.doRender(entityRhinoBeetle, x, y, z, rotationYaw, partialTickTime);
	}

	@Override
	public void doRender(EntityLiving entityLiving, double x, double y, double z, float rotationYaw, float partialTickTime) {
		renderRhinoBeetle((EntityRhinoBeetle) entityLiving, x, y, z, rotationYaw, partialTickTime);
	}

	@Override
	public void doRender(Entity entity, double x, double y, double z, float rotationYaw, float partialTickTime) {
		renderRhinoBeetle((EntityRhinoBeetle) entity, x, y, z, rotationYaw, partialTickTime);
	}
