...
public class TileEntityPortalRenderer extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity t, double x, double y1, double z, float otherThing) {
		...
		if (tile.renderBeam()) {
			...
			float f2 = tile.getWorldObj().getTotalWorldTime() + otherThing;
			...
			double d23 = 256.0F * thing;
			double d25 = 0.0D;
			double d27 = 1.0D;
			double d28 = -1.0F + f3;
			double d29 = 256.0F * thing * (0.5D / d5) + d28;
			...
			double d14 = 0.8D;
			double d16 = 0.8D;
			double d18 = 256.0F * thing;
			double d20 = 0.0D;
			double d22 = 1.0D;
			double d24 = -1.0F + f3;
			double d26 = 256.0F * thing + d24;
