...
public class WaspSwordSpecialRenderer implements NoDataSpecialModelRenderer {

    private final WaspSwordModel model;

    public WaspSwordSpecialRenderer(WaspSwordModel model) {
        this.model = model;
    }
