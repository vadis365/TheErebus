...
public class WebSlingerRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    private final Identifier TEXTURE = Erebus.prefix("textures/special/items/web_slinger.png");
    private final Identifier TEXTURE_WITHER = Erebus.prefix("textures/special/items/web_slinger_wither.png");
