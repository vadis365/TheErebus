...
public class ModelFireAntSoldier extends ModelBase {
	...
	public void setRotationAngles(float limbSwing, float limbSwingAngle, float entityTickTime, float rotationYaw, float rotationPitch, float unitPixel, Entity entity) {
		...
		this.HeadA.rotateAngleY = headY;
		this.HeadB.rotateAngleY = headY;
		this.AntLS.rotateAngleY = headY;
		this.AntLE.rotateAngleY = headY;
		this.AntRS.rotateAngleY = headY;
		this.AntRE.rotateAngleY = headY;
		this.Eyes.rotateAngleY = headY;
		this.RMandibleA.rotateAngleY = headY;
		this.RMandibleB.rotateAngleY = headY;
		this.LMandibleA.rotateAngleY = headY;
		this.LMandibleB.rotateAngleY = headY;
		this.HeadA.rotateAngleX = headX;
		this.HeadB.rotateAngleX = headX;
		this.AntLS.rotateAngleX = headX;
		this.AntLE.rotateAngleX = headX;
		this.AntRS.rotateAngleX = headX;
		this.AntRE.rotateAngleX = headX;
		this.Eyes.rotateAngleX = headX;
		this.RMandibleA.rotateAngleX = headX;
		this.RMandibleB.rotateAngleX = headX;
		this.LMandibleA.rotateAngleX = headX;
		this.LMandibleB.rotateAngleX = headX;
		this.LBLA.rotateAngleX = legX2 + 0.25F;
		this.LBLB.rotateAngleX = legX2 + 0.25F;
		this.LBLC.rotateAngleX = legX2 + 0.5F;
		this.LBLD.rotateAngleX = legX2 + 0.64F;
		this.LMLA.rotateAngleX = legX;
		this.LMLB.rotateAngleX = legX;
		this.LMLC.rotateAngleX = legX;
		this.LMLD.rotateAngleX = legX;
		this.LFLA.rotateAngleX = legX2 - 0.25F;
		this.LFLB.rotateAngleX = legX2 - 0.25F;
		this.LFLC.rotateAngleX = legX2 - 0.5F;
		this.LFLD.rotateAngleX = legX2 - 0.64F;
		this.RBLA.rotateAngleX = legX + 0.25F;
		this.RBLB.rotateAngleX = legX + 0.25F;
		this.RBLC.rotateAngleX = legX + 0.5F;
		this.RBLD.rotateAngleX = legX + 0.64F;
		this.RMLA.rotateAngleX = legX2;
		this.RMLB.rotateAngleX = legX2;
		this.RMLC.rotateAngleX = legX2;
		this.RMLD.rotateAngleX = legX2;
		this.RFLA.rotateAngleX = legX - 0.25F;
		this.RFLB.rotateAngleX = legX - 0.25F;
		this.RFLC.rotateAngleX = legX - 0.5F;
		this.RFLD.rotateAngleX = legX - 0.64F;
	}
}
