...
public class ModelCrushling extends ModelBase {
	...
	public void setRotationAngles(float limbSwing, float limbSwingAngle, float entityTickTime, float rotationYaw, float rotationPitch, float unitPixel, Entity entity) {
		...
		float movcos1 = MathHelper.cos(limbSwing * 2.0F) * 1.0F * limbSwingAngle * 2F;
		float movsin1 = MathHelper.sin(limbSwing * 2.0F) * 1.0F * limbSwingAngle * 2F;

		rightArm1.setRotationPoint(-9F, -10F, 1F);
		leftArm1.setRotationPoint(9F, -10F, 1F);
		rightArm1.rotateAngleZ = -movcos1 * 0.3F;
		leftArm1.rotateAngleZ = movcos1 * 0.3F;
