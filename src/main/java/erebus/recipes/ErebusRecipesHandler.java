...
public class ErebusRecipesHandler {
	...
	private static void smoothieMaker() {
		...
		SmoothieMakerRecipe.addRecipe(SmoothieType.BRYUFS_BREW.makeStack(), ItemMaterials.DATA.SMOOTHIE_GLASS.makeStack(), new Fluid[] { ModFluids.honey, ModFluids.milk, ModFluids.antiVenom, ModFluids.beetleJuice }, ItemMaterials.DATA.COMPOUND_EYES.makeStack(), new ItemStack(ModBlocks.darkCapped), new ItemStack(ModItems.turnip), new ItemStack(ModItems.heartBerries));
