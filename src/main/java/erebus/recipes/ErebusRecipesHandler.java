...
public class ErebusRecipesHandler {
	...
	private static void smoothieMaker() {
		...
		SmoothieMakerRecipe.addRecipe(SmoothieType.BRYUFS_BREW.makeStack(), ItemMaterials.DATA.smoothieGlass.makeStack(), new Fluid[] { ModFluids.honey, ModFluids.milk, ModFluids.antiVenom, ModFluids.beetleJuice }, ItemMaterials.DATA.compoundEyes.makeStack(), new ItemStack(ModBlocks.darkCapped), new ItemStack(ModItems.turnip), new ItemStack(ModItems.heartBerries));
