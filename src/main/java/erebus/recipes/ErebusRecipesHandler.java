...
public class ErebusRecipesHandler {
	...
	private static void smoothieMaker() {
		...
		SmoothieMakerRecipe.addRecipe(SmoothieType.HOT_HOT_BABY.createStack(), ItemMaterials.EnumErebusMaterialsType.SMOOTHIE_GLASS.createStack(), ModFluids.ANTI_VENOM, ItemMaterials.EnumErebusMaterialsType.WASP_STING.createStack(), ItemMaterials.EnumErebusMaterialsType.BOGMAW_ROOT.createStack(), new ItemStack(Item.getItemFromBlock(ModBlocks.SMALL_PLANT), 1, EnumSmallPlantType.FIRE_BLOOM.ordinal()), new ItemStack(Item.getItemFromBlock(ModBlocks.SMALL_PLANT), 1, EnumSmallPlantType.FIRE_BLOOM.ordinal()));
