...
public class ContainerComposter extends Container {
	...
	public ContainerComposter(InventoryPlayer player, TileEntityComposter composter) {
		...
		addSlotToContainer(new Slot(composter, 0, 56, 17));
		addSlotToContainer(new Slot(composter, 1, 56, 53));
		addSlotToContainer(new SlotFurnace(player.player, composter, 2, 116, 35));
		int i;
