...
public class UmberstoneBlocks extends ModBlockHelpers {
    ...
    public static final DeferredBlock<Block> PETRIFIED_WOOD_ROCK;
    public static final DeferredBlock<Block> PETRIFIED_WOOD_ROCK_2;
    public static final DeferredBlock<Block> PETRIFIED_WOOD_ROCK_3;
    public static final DeferredBlock<Block> PETRIFIED_WOOD_ROCK_4;
    public static final DeferredBlock<Block> PETRIFIED_WOOD_ROCK_5;
    public static final DeferredBlock<Block> PETRIFIED_WOOD_ROCK_6;
    ...
    static {
        ...
        PETRIFIED_WOOD_ROCK = registerSimpleBlock("petrified_wood_rock", Properties.of().mapColor(MapColor.STONE));
        PETRIFIED_WOOD_ROCK_2 = registerSimpleBlock("petrified_wood_rock_2", Properties.of().mapColor(MapColor.STONE));
        PETRIFIED_WOOD_ROCK_3 = registerSimpleBlock("petrified_wood_rock_3", Properties.of().mapColor(MapColor.STONE));
