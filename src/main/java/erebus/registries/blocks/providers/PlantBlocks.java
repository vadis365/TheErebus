...
public class PlantBlocks extends ModBlockHelpers {
    ...
    static {
        ...
        HANGING_WEB = registerSimpleBlock("hanging_web", Properties.of().mapColor(MapColor.STONE));

        // MARK: Flowers
        PETAL_BLACK = registerSimpleBlock("petal_black", Properties.of().mapColor(MapColor.STONE));
        PETAL_RED = registerSimpleBlock("petal_red", Properties.of().mapColor(MapColor.STONE));
        PETAL_BROWN = registerSimpleBlock("petal_brown", Properties.of().mapColor(MapColor.STONE));
        PETAL_BLUE = registerSimpleBlock("petal_blue", Properties.of().mapColor(MapColor.STONE));
        PETAL_PURPLE = registerSimpleBlock("petal_purple", Properties.of().mapColor(MapColor.STONE));
        PETAL_CYAN = registerSimpleBlock("petal_cyan", Properties.of().mapColor(MapColor.STONE));
        PETAL_LIGHT_GRAY = registerSimpleBlock("petal_light_gray", Properties.of().mapColor(MapColor.STONE));
        PETAL_GRAY = registerSimpleBlock("petal_gray", Properties.of().mapColor(MapColor.STONE));
        PETAL_PINK = registerSimpleBlock("petal_pink", Properties.of().mapColor(MapColor.STONE));
        PETAL_YELLOW = registerSimpleBlock("petal_yellow", Properties.of().mapColor(MapColor.STONE));
        PETAL_LIGHT_BLUE = registerSimpleBlock("petal_light_blue", Properties.of().mapColor(MapColor.STONE));
        PETAL_MAGENTA = registerSimpleBlock("petal_magenta", Properties.of().mapColor(MapColor.STONE));
        PETAL_ORANGE = registerSimpleBlock("petal_orange", Properties.of().mapColor(MapColor.STONE));
        PETAL_WHITE = registerSimpleBlock("petal_white", Properties.of().mapColor(MapColor.STONE));

        EXPLODING_STIGMA = registerSimpleBlock("exploding_stigma", Properties.of().mapColor(MapColor.STONE));
        STEM = registerSimpleBlock("stem", Properties.of().mapColor(MapColor.STONE));
        STIGMA_BLACK = registerSimpleBlock("stigma_black", Properties.of().mapColor(MapColor.STONE));
        STIGMA_RED = registerSimpleBlock("stigma_red", Properties.of().mapColor(MapColor.STONE));
        STIGMA_BROWN = registerSimpleBlock("stigma_brown", Properties.of().mapColor(MapColor.STONE));
        STIGMA_BLUE = registerSimpleBlock("stigma_blue", Properties.of().mapColor(MapColor.STONE));
        STIGMA_PURPLE = registerSimpleBlock("stigma_purple", Properties.of().mapColor(MapColor.STONE));
        STIGMA_CYAN = registerSimpleBlock("stigma_cyan", Properties.of().mapColor(MapColor.STONE));
        STIGMA_LIGHT_GRAY = registerSimpleBlock("stigma_light_gray", Properties.of().mapColor(MapColor.STONE));
        STIGMA_GRAY = registerSimpleBlock("stigma_gray", Properties.of().mapColor(MapColor.STONE));
        STIGMA_PINK = registerSimpleBlock("stigma_pink", Properties.of().mapColor(MapColor.STONE));
        STIGMA_YELLOW = registerSimpleBlock("stigma_yellow", Properties.of().mapColor(MapColor.STONE));
        STIGMA_LIGHT_BLUE = registerSimpleBlock("stigma_light_blue", Properties.of().mapColor(MapColor.STONE));
        STIGMA_MAGENTA = registerSimpleBlock("stigma_magenta", Properties.of().mapColor(MapColor.STONE));
        STIGMA_ORANGE = registerSimpleBlock("stigma_orange", Properties.of().mapColor(MapColor.STONE));
        STIGMA_WHITE = registerSimpleBlock("stigma_white", Properties.of().mapColor(MapColor.STONE));

        FLOWER_BLACK = registerSimpleBlock("flower_black", Properties.of().mapColor(MapColor.STONE));
        FLOWER_RED = registerSimpleBlock("flower_red", Properties.of().mapColor(MapColor.STONE));
        FLOWER_BROWN = registerSimpleBlock("flower_brown", Properties.of().mapColor(MapColor.STONE));
        FLOWER_BLUE = registerSimpleBlock("flower_blue", Properties.of().mapColor(MapColor.STONE));
        FLOWER_PURPLE = registerSimpleBlock("flower_purple", Properties.of().mapColor(MapColor.STONE));
        FLOWER_CYAN = registerSimpleBlock("flower_cyan", Properties.of().mapColor(MapColor.STONE));
        FLOWER_LIGHT_GRAY = registerSimpleBlock("flower_light_gray", Properties.of().mapColor(MapColor.STONE));
        FLOWER_GRAY = registerSimpleBlock("flower_gray", Properties.of().mapColor(MapColor.STONE));
        FLOWER_PINK = registerSimpleBlock("flower_pink", Properties.of().mapColor(MapColor.STONE));
        FLOWER_YELLOW = registerSimpleBlock("flower_yellow", Properties.of().mapColor(MapColor.STONE));
        FLOWER_LIGHT_BLUE = registerSimpleBlock("flower_light_blue", Properties.of().mapColor(MapColor.STONE));
        FLOWER_MAGENTA = registerSimpleBlock("flower_magenta", Properties.of().mapColor(MapColor.STONE));
        FLOWER_ORANGE = registerSimpleBlock("flower_orange", Properties.of().mapColor(MapColor.STONE));
        FLOWER_WHITE = registerSimpleBlock("flower_white", Properties.of().mapColor(MapColor.STONE));
        FLOWER_RAINBOW = registerSimpleBlock("flower_rainbow", Properties.of().mapColor(MapColor.STONE));
