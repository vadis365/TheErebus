...
public class ModFoliagePlacers {
    ...
    public static final DeferredHolder<FoliagePlacerType<?>, FoliagePlacerType<SingleLeafFoliagePlacer>> SINGLE_LEAF_FOLIAGE_PLACER = register("single_leaf_foliage_placer", SingleLeafFoliagePlacer.CODEC);
