...
public class ModFoliagePlacers {
    ...
    public static final DeferredHolder<FoliagePlacerType<?>, FoliagePlacerType<EucalyptusFoliagePlacer>> EUCALYPTUS_FOLIAGE_PLACER = register("eucalyptus_foliage_placer", EucalyptusFoliagePlacer.CODEC);
