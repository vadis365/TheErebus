 ...
 * @author Azanor
 * 
 *         This is used to gain access to the items in my mod. I only give some
 *         examples and it will probably still require a bit of work for you to
...
public class ItemApi {
	 ...
	 * Some examples
	 * 
	 * Casting Wands: itemWandCasting
	 * 
	 * Resources: itemEssence, itemWispEssence, itemResource, itemShard,
	 * itemNugget, itemNuggetChicken, itemNuggetBeef, itemNuggetPork,
	 * itemTripleMeatTreat
	 * 
