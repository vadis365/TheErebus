...
public class ResearchPage {
	public static enum PageType {
		TEXT, TEXT_CONCEALED, IMAGE, CRUCIBLE_CRAFTING, ARCANE_CRAFTING, ASPECTS, NORMAL_CRAFTING, INFUSION_CRAFTING, COMPOUND_CRAFTING
	}
	...
	/**
	 * @param research
	 *            this page will only be displayed if the player has discovered
	 *            this research
	 * @param text
	 *            this can (but does not have to) be a reference to a
	 *            localization variable, not the actual text.
	...
	/**
	 * @param recipe
	 *            a collection of infusion crafting recipes.
	 */
	...
	/**
	 * @param recipe
	 *            an arcane worktable crafting recipe.
	 */
	public ResearchPage(IArcaneRecipe recipe) {
		type = PageType.ARCANE_CRAFTING;
		this.recipe = recipe;
	...
	public ResearchPage(CrucibleRecipe recipe) {
		...
		this.recipe = recipe;
		recipeOutput = recipe.recipeOutput;
	}
	...
	public ResearchPage(InfusionRecipe recipe) {
		...
		if (recipe.recipeOutput instanceof ItemStack)
			recipeOutput = (ItemStack) recipe.recipeOutput;
		else
			recipeOutput = recipe.recipeInput;
	}
