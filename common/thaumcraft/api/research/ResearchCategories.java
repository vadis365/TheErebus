...
public class ResearchCategories {
	...
	/**
	 * @param key
	 * @return the name of the research category linked to this key. Must be
	 *         stored as localization information in the LanguageRegistry.
	 */
	...
	/**
	 * @param key
	 *            the key used for this category
	 * @param icon
	 *            the icon to be used for the research category tab
	 * @param background
	 *            the resource location of the background image to use for this
	 *            category
