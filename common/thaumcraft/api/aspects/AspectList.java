...
public class AspectList implements Serializable {
	...
	public LinkedHashMap<Aspect, Integer> aspects = new LinkedHashMap<Aspect, Integer>();// aspects
																							// associated
																							// with
																							// this
																							// object
	 ...
	 * 
	 * @param id
	 *            the item/block id of an existing item
	 * @param meta
	 *            the damage value of an existing item
	 */
	...
	/**
	 * Adds this aspect and amount to the collection. If the aspect exists then
	 * its value will be increased by the given amount.
	 * 
	 * @param aspect
	 * @param amount
	 * @return
	...
	/**
	 * Adds this aspect and amount to the collection. If the aspect exists then
	 * only the highest of the old or new amount will be used.
	 * 
	 * @param aspect
	 * @param amount
	 * @return
