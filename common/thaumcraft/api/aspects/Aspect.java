...
public class Aspect {
	 ...
	 * 
	 * @param tag
	 *            the key that will be used to reference this aspect, as well as
	 *            its latin display name
	 * @param color
	 *            color to display the tag in
	 * @param components
	 *            the aspects this one is formed from
	 * @param image
	 *            ResourceLocation pointing to a 32x32 icon of the aspect
	 * @param blend
	 *            GL11 blendmode (1 or 771). Used for rendering nodes. Default
	 *            is 1
	 */
	...
	/**
	 * Shortcut constructor I use for the default aspects - you shouldn't be
	 * using this.
	 */
	...
	/**
	 * Shortcut constructor I use for the primal aspects - you shouldn't use
	 * this as making your own primal aspects will break all the things.
	 */
	...
	// public static final Aspect LAVA = new Aspect("lava",0xe85729, new
	// Aspect[] {EARTH, FIRE});
	// public static final Aspect STEAM = new Aspect("steam",0xFFFFFF, new
	// Aspect[] {WATER, FIRE});
	// public static final Aspect MUD = new Aspect("lutum",0x473423, new
	// Aspect[] {WATER, EARTH});
	// public static final Aspect SAND = new Aspect("sand",0xFFFFFF, new
	// Aspect[] {AIR, EARTH});
	// public static final Aspect ASTRAL = new Aspect("Astral",0xFFFFFF, new
	// Aspect[] {VOID, DARKNESS});
	// public static final Aspect HARM = new Aspect("Harm",0xFFFFFF, new
	// Aspect[] {ENTROPY, LIFE});
	// public static final Aspect BIRD = new Aspect("Bird",0xFFFFFF, new
	// Aspect[] {BEAST, AIR});
	// public static final Aspect FISH = new Aspect("Fish",0xFFFFFF, new
	// Aspect[] {BEAST, WATER});
