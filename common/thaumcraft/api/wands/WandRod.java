 ...
 * @author Azanor
 * 
 *         This class is used to keep the material information for the various
 *         rods. It is also used to generate the wand recipes ingame.
 * 
 */
public class WandRod {
	...
	/**
	 * the actual item that makes up this rod and will be used to generate the
	 * wand recipes
	 */
	ItemStack item;
	...
	// Some examples:
	// WandRod WAND_ROD_WOOD = new WandRod("wood",25,new
	// ItemStack(Item.stick),1);
	// WandRod WAND_ROD_BLAZE = new WandRod("blaze",100,new
	// ItemStack(Item.blazeRod),7,new WandRodBlazeOnUpdate());
}
