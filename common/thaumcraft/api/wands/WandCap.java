...
public class WandCap {
	...
	/**
	 * specifies a list of primal aspects that use the special discount figure
	 * instead of the normal discount.
	 */
	...
	/**
	 * the actual item that makes up this cap and will be used to generate the
	 * wand recipes
	 */
	ItemStack item;
	...
	// Some examples:
	// WandCap WAND_CAP_IRON = new WandCap("iron", 1.1f,
	// Arrays.asList(Aspect.ORDER),1, new
	// ItemStack(ConfigItems.itemWandCap,1,0),1);
	// WandCap WAND_CAP_GOLD = new WandCap("gold", 1f, new
	// ItemStack(ConfigItems.itemWandCap,1,1),3);
