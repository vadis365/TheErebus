...
public class TileEntityErebusAltarLightningRenderer extends TileEntityErebusAltarRenderer {
	private static final ResourceLocation[] tex = new ResourceLocation[] { new ResourceLocation("erebus:textures/special/tiles/EngineOfIllapa1.png"), new ResourceLocation("erebus:textures/special/tiles/EngineOfIllapa2.png"), new ResourceLocation("erebus:textures/special/tiles/EngineOfIllapa3.png"), new ResourceLocation("erebus:textures/special/tiles/EngineOfIllapa4.png"), new ResourceLocation("erebus:textures/special/tiles/EngineOfIllapa5.png"),
	new ResourceLocation("erebus:textures/special/tiles/EngineOfIllapa6.png"), new ResourceLocation("erebus:textures/special/tiles/EngineOfIllapa7.png") };
