...
public class ModelCicada extends ModelBase {
	...
	public ModelCicada() {
		...
		ThoraxTop.setTextureSize(64, 32);
		...
		RWingTop.setRotationPoint(-4F, 14F, -6F);
		RWingTop.setTextureSize(64, 32);
		RWingTop.mirror = true;
		setRotation(RWingTop, -0.1745329F, 0F, 0.4363323F);
		RWingMain = new ModelRenderer(this, 16, 102);
		RWingMain.addBox(-1F, -3F, 1F, 1, 6, 17);
		RWingMain.setRotationPoint(-4F, 14F, -6F);
		RWingMain.setTextureSize(64, 32);
		RWingMain.mirror = true;
		setRotation(RWingMain, -0.1745329F, 0F, 0.4363323F);
		RWingBack = new ModelRenderer(this, 49, 96);
		RWingBack.addBox(-1F, -2F, 18F, 1, 4, 1);
		RWingBack.setRotationPoint(-4F, 14F, -6F);
		RWingBack.setTextureSize(64, 32);
		RWingBack.mirror = true;
		setRotation(RWingBack, -0.1745329F, 0F, 0.4363323F);
		...
		LWingTop.setRotationPoint(4F, 14F, -6F);
		LWingTop.setTextureSize(64, 32);
		LWingTop.mirror = true;
		setRotation(LWingTop, -0.1745329F, 0F, -0.4363323F);
		LWingMain = new ModelRenderer(this, 16, 102);
		LWingMain.addBox(0F, -3F, 1F, 1, 6, 17);
		LWingMain.setRotationPoint(4F, 14F, -6F);
		LWingMain.setTextureSize(64, 32);
		LWingMain.mirror = true;
		setRotation(LWingMain, -0.1745329F, 0F, -0.4363323F);
		LWingBack = new ModelRenderer(this, 16, 63);
		LWingBack.addBox(0F, -2F, 18F, 1, 4, 1);
		LWingBack.setRotationPoint(4F, 14F, -6F);
		LWingBack.setTextureSize(64, 32);
		LWingBack.mirror = true;
		setRotation(LWingBack, -0.1745329F, 0F, -0.4363323F);
	}
	...
	public void render(Entity entity, float limbSwing, float prevLimbSwing, float entityTickTime, float rotationYaw, float rotationPitch, float unitPixel) {
		...
		RWingTop.render(unitPixel);
		RWingMain.render(unitPixel);
		RWingBack.render(unitPixel);
		LWingFront.render(unitPixel);
		LWingTop.render(unitPixel);
		LWingMain.render(unitPixel);
