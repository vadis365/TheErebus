...
public class ModelMosquito extends ModelBase {
	...
	public ModelMosquito() {
		...
		Head1[0].setTextureSize(128, 128);
		Head1[0].mirror = true;
		...
		Head1[1].setTextureSize(128, 128);
		Head1[1].mirror = true;
		...
		Head2[0].setTextureSize(128, 128);
		Head2[0].mirror = true;
		...
		Head2[1].setTextureSize(128, 128);
		Head2[1].mirror = true;
		...
		Head3[0].setTextureSize(128, 128);
		Head3[0].mirror = true;
		...
		Head3[1].setTextureSize(128, 128);
		Head3[1].mirror = true;
		...
		Head4[0].setTextureSize(128, 128);
		Head4[0].mirror = true;
		...
		Head4[1].setTextureSize(128, 128);
		Head4[1].mirror = true;
		...
		LegLeft1[0].setTextureSize(128, 128);
		LegLeft1[0].mirror = true;
		...
		LegLeft1[1].setTextureSize(128, 128);
		LegLeft1[1].mirror = true;
		...
		LegLeft2[0].setTextureSize(128, 128);
		LegLeft2[0].mirror = false;
		...
		LegLeft2[1].setTextureSize(128, 128);
		LegLeft2[1].mirror = true;
		...
		LegLeft3[0].setTextureSize(128, 128);
		LegLeft3[0].mirror = true;
		...
		LegLeft3[1].setTextureSize(128, 128);
		LegLeft3[1].mirror = true;
		...
		LegRight1[0].setTextureSize(128, 128);
		LegRight1[0].mirror = false;
		...
		LegRight1[1].setTextureSize(128, 128);
		LegRight1[1].mirror = false;
		...
		LegRight2[0].setTextureSize(128, 128);
		LegRight2[0].mirror = false;
		...
		LegRight2[1].setTextureSize(128, 128);
		LegRight2[1].mirror = false;
		...
		LegRight3[0].setTextureSize(128, 128);
		LegRight3[0].mirror = false;
		...
		LegRight3[1].setTextureSize(128, 128);
		LegRight3[1].mirror = false;
