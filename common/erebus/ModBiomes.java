...
public class ModBiomes {
	...
	public static void init() {
		...
		elysianFields = new BiomeGenElysianFields(elysianFieldsID).setColor(0).func_76733_a(0).setDisableRain().setTemperatureRainfall(0F,0F).setBiomeName("Elysian Fields");
