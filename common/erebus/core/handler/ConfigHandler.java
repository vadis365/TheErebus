...
public class ConfigHandler {
	...
	public static int erebusOreExtraID, umberstoneButtonID, logErebusGroup1ID, logErebusGroup2ID, logErebusGroup3ID, planksErebusID, leavesErebusID;
	...
	public static int encrustedDiamondID;
	...
	public static void loadConfig(FMLPreInitializationEvent event) {
		...
		try {
			...
			logErebusGroup3ID = config.getBlock("Block ID of Log - group 3", 2613).getInt(2613);
			...
			erebusMushroomCap0ID = config.getBlock("Block ID of Bulb Capped Mushroom", 2608).getInt(2608);
			erebusMushroomCap1ID = config.getBlock("Block ID of Giant Mushroom 1", 2609).getInt(2609);
			erebusMushroomCap2ID = config.getBlock("Block ID of Giant Mushroom 2", 2610).getInt(2610);
			erebusMushroomCap3ID = config.getBlock("Block ID of Giant Mushroom 3", 2611).getInt(2611);
			erebusMushroomCap4ID = config.getBlock("Block ID of Giant Mushroom 4", 2612).getInt(2612);
			erebusPlantSmallID = config.getBlock("Block ID of Small Plants and Mushrooms", 2603).getInt(2603);
			...
			// latest ID used (please update after adding new blocks!) >>> 2614
			...
			encrustedDiamondID = config.getItem("Item ID of Encrusted Diamond", 9759).getInt(9759);
			...
			// latest ID used (please update after adding new items!) >>> 9759
