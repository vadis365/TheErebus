...
public class WorldGenMossbarkTree extends WorldGenerator{
	...
	public boolean generate(World world, Random rand, int x, int y, int z){
		...
		if (world.getBlockId(x,y-1,z)!=Block.dirt.blockID&&world.getBlockId(x,y-1,z)!=Block.grass.blockID)return false;
	...
	public void generateMiddleBranch(World world, Random rand, int x, int y, int z, int height){
		...
		for(int yy=0; yy<height; ++yy)world.setBlock(x,y+yy,z,ModBlocks.logErebusGroup2.blockID,BlockLogErebus.dataMossbark,3);
	}
