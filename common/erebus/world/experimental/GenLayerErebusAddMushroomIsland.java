...
public class GenLayerErebusAddMushroomIsland extends GenLayerErebus {
	public GenLayerErebusAddMushroomIsland(long seed, GenLayerErebus parentGenLayer) {
		super(seed);
	 ...
	 * based on the particular GenLayerErebus subclass.
	 */
	@Override
